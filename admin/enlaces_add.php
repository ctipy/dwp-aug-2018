  ...
  <?php
    ...
    if( isset($_POST) ){
        ...
        if($_POST['guardar'] == 'guardar' && $_POST['nombre'] != '' ){
            ...
            $sql = 'INSERT INTO links (nombre, id_padre, url, target, visible, fecha_add ) VALUES (:nombre, :id_padre, :url, :target, :visible, NOW() )';
...
<div class="panel">
        <div class="row">
          <div class="col-xs-12">
            ...
            <a href="enlaces.php" class="btn btn-warning btn-lg pull-right" href=""> <i class="fa fa-close"></i> Salir</a>
        </div>
